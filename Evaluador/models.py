...
class plantillaECC(models.Model):
    ...
    Comite_de_etica=models.IntegerField(choices=CHOICES,blank=False,default=1)
    metodos=models.IntegerField(choices=CHOICES,blank=False,default=1, help_text='Registrado en clinicaltrials.gov')
...
class plantillaRSyMA(models.Model):
    ...
    daprpi = models.IntegerField(choices=CALIFICACION,default=1,blank=False,help_text='Diseño adecuado para responder pregunta de investigación')
    Comite_de_etica=models.IntegerField(choices=CHOICES,blank=False,default=1)
    metodos=models.IntegerField(choices=CALIFICACION,blank=False,default=1, help_text='Definición clara y explícita de preguntas de investigación.')
...
class plantillaSERIECASOSyCOHORTESTRANSVERSALES(models.Model):
    ...
    daprpi = models.IntegerField(choices=CALIFICACION,default=1,blank=False,help_text='Diseño adecuado para responder pregunta de investigación')
    Comite_de_etica=models.IntegerField(choices=CHOICES,blank=False,default=1)
    ddmtpc=models.IntegerField(choices=CALIFICACION,blank=False,default=1, help_text='Definición de la muestra: tamaño y probabilística vs conveniencia.')
